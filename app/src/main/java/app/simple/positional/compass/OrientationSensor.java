...
public class OrientationSensor implements SensorEventListener {
    ...
    public OrientationSensor(SensorManager sm, SensorEventListener parent, ImageView imageView) {
        m_sm = sm;
        m_parent = parent;
        m_activity = null;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (m_NormGravityVector != null && m_NormMagFieldValues != null) {
            ...
            if (m_Norm_Gravity * m_Norm_MagField * norm_East < 0.1f) {  // Typical values are  > 100.
                ...
                needle.setRotation(m_azimuth_radians);
                System.out.println(m_azimuth_radians);
            }
        }
