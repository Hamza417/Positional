...
public class FastScrollerBuilder {
    ...
    public FastScrollerBuilder useMd2Style() {
        ...
        mTrackDrawable = ResourcesCompat.getDrawable(context.getResources(), R.drawable.fs_md2_track, context.getTheme());
        mThumbDrawable = ResourcesCompat.getDrawable(context.getResources(), R.drawable.fs_md2_thumb, context.getTheme());
