...
class BouncyNestedScrollView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    init {
        ...
        context.theme.obtainStyledAttributes(attrs, R.styleable.BouncyNestedScrollView, 0, 0)
                .apply {
                    overscrollAnimationSize = getFloat(R.styleable.BouncyNestedScrollView_overscroll_animation_size, 0.75f)
                    flingAnimationSize = getFloat(R.styleable.BouncyNestedScrollView_fling_animation_size, 0.75f)
