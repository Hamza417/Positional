...
import app.simple.positional.decorations.utils.BouncyEdgeEffect
...
class DynamicCornerBouncyNestedScrollView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    interface OnScrollChangeListener {
        fun onScrollChange(v: DynamicCornerBouncyNestedScrollView?, scrollX: Int, scrollY: Int, oldScrollX: Int, oldScrollY: Int)
    }
    ...
    internal class AccessibilityDelegate : AccessibilityDelegateCompat() {
        override fun performAccessibilityAction(host: View, action: Int, arguments: Bundle): Boolean {
            ...
            val nsvHost = host as DynamicCornerBouncyNestedScrollView
