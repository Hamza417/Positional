...
class PopupDirectionsMenu(anchor: View) : BasePopupWindow() {
    ...
    init {
        ...
        contentView.findViewById<DynamicRippleTextView>(R.id.menu_edit).setOnClickListener {
            popupDirectionsCallbacks?.onEdit().also {
                dismiss()
            }
        }
        ...
        contentView.findViewById<DynamicRippleTextView>(R.id.menu_navigate).setOnClickListener {
            popupDirectionsCallbacks?.onNavigate().also {
                dismiss()
            }
        }
    }
